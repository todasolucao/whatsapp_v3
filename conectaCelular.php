<div class="_3BqNZ" style="display:none">
    ...
    <div class="_2MnNk" style="opacity: 1; transform: translateY(0px);">
        <h1 class="iHhHL">Mantenha seu celular conectado</h1>
        <div class="_1ClcF">O WhatsApp conecta ao seu telefone para sicronizar suas mensagens
            <div class="_1Y6o1">
